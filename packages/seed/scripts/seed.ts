...
// mirrors PermissionsService.onModuleInit() in admin-api — seed.ts
...
// mirrors RolesService.createSystemRole() in admin-api
...
async function main() {
  ...
  console.log(`Sign in at admin-web with ${OWNER_EMAIL} / ${OWNER_PASSWORD}`);
  process.exit(0);
}
